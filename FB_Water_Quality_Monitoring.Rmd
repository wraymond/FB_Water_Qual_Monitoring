...
p.temp <- ggplot(dat %>%
  ...
  geom_point(aes(x = sample_date, y = temp_c, shape = station_abb, color = station_abb), size = 1.5) +
  scale_shape_manual(values = c(15, 17, 16), labels = c("Bailer", "Mouth", "Nearshore")) +
  scale_color_manual(values = c("#D41E58", "#678F22", "#14409E")) +
  labs(color = "Station") +
...
p.sal <- ggplot(dat %>%
         filter(station_id %in% c("FBWS_1", "FBWS_2"))) +
  geom_point(aes(x = sample_date, y = sal_ppt, shape = station_abb, color = station_abb), size = 1.5) +
  scale_shape_manual(values = c(17, 16), labels = c("Mouth", "Nearshore")) +
  scale_color_manual(values = c( "#678F22", "#14409E")) +
  labs(color = "Station") +
  theme(legend.position = "none") +
  scale_y_continuous(limits = c(0, 36), breaks = seq(0, 36, by = 4))  +
  scale_x_datetime(date_breaks = "month", date_labels = "%b %y", limits = c(as.POSIXct("2021-03-30"), as.POSIXct("2022-09-01"))) +
...
p.tp <- ggplot(dat %>%
         filter(station_id %in% c("FBWS_1", "FBWS_2", "FBWS_3"))) +
  geom_point(aes(x = sample_date, y = TP_umol, shape = station_abb, color = station_abb), size = 1.5) +
  scale_shape_manual(values = c(15, 17, 16), labels = c("Bailer", "Mouth", "Nearshore")) +
  scale_color_manual(values = c("#D41E58", "#678F22", "#14409E")) +
  scale_y_continuous(limits = c(0, 20), breaks = seq(0, 20, by = 5)) +
  scale_x_datetime(date_breaks = "month", date_labels = "%b %y", limits = c(as.POSIXct("2021-03-30"), as.POSIXct("2022-09-01"))) +
...
p.tn <- ggplot(dat %>%
         filter(station_id %in% c("FBWS_1", "FBWS_2", "FBWS_3"))) +
  geom_point(aes(x = sample_date, y = TN_umol, shape = station_abb, color = station_abb), size = 1.5) +
  scale_shape_manual(values = c(15, 17, 16), labels = c("Bailer", "Mouth", "Nearshore")) +
  scale_color_manual(values = c("#D41E58", "#678F22", "#14409E")) +
...
p.po4 <- ggplot(dat %>% 
         filter(station_id %in% c("FBWS_1", "FBWS_2"))) +
  geom_point(aes(x = sample_date, y = PO4_umol, shape = station_abb, color = station_abb), size = 1.5) +
  scale_shape_manual(values = c(17, 16), labels = c("Mouth", "Nearshore")) +
  labs(color = "Station") +
  scale_color_manual(values = c( "#678F22", "#14409E")) +
  theme(legend.position = "none") +
...
p.no3 <- ggplot(dat %>% 
         filter(station_id %in% c("FBWS_1", "FBWS_2"))) +
  geom_point(aes(x = sample_date, y = NO3_umol, shape = station_abb, color = station_abb), size = 1.5) +
  scale_shape_manual(values = c(17, 16), labels = c("Mouth", "Nearshore")) +
  scale_color_manual(values = c( "#678F22", "#14409E")) +
  labs(color = "Station") +
  theme(legend.position = "none") +
...
p.no2 <- ggplot(dat %>% 
         filter(station_id %in% c("FBWS_1", "FBWS_2"))) +
  geom_point(aes(x = sample_date, y = NO2_umol, shape = station_abb, color = station_abb), size = 1.5) +
  scale_shape_manual(values = c(17, 16), labels = c("Mouth", "Nearshore")) +
  scale_color_manual(values = c( "#678F22", "#14409E")) +
  labs(color = "Station") +
  theme(legend.position = "none") +
...
p.nh4 <- ggplot(dat %>% 
         filter(station_id %in% c("FBWS_1", "FBWS_2"))) +
  geom_point(aes(x = sample_date, y = NH4_umol, shape = station_abb, color = station_abb), size = 1.5) +
  scale_shape_manual(values = c(17, 16), labels = c("Mouth", "Nearshore")) +
  scale_color_manual(values = c( "#678F22", "#14409E")) +
  labs(color = "Station") +
  theme(legend.position = "none") +
